...
import { EMAIL_FIELD_ERROR_PERSON, INPUT_MIN_LENGTH_ERROR, REQUIRED_FIELD_ERROR, TOAST_ERROR_DESCRIPTION, TOAST_ERROR_TITLE, TOAST_SUCCESS_TITLE, TOAST_SUCCESS_UPDATED_TITLE } from "src/constants/messages";
import { BUTTON_ADD, BUTTON_CANCEL, BUTTON_UPDATE, INPUT_DOCUMENT_NUMBER_FORM_PERSON, INPUT_EMAIL_FORM_PERSON, INPUT_LASTNAME_FORM_PERSON, INPUT_NAME_FORM_PERSON, INPUT_PASSWORD_FORM_PERSON, INPUT_SUBJECT_FORM_PERSON } from "src/constants/strings";
